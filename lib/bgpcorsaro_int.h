...
#ifdef WITH_PLUGIN_IPMETA
  /** Set of libipmeta records based on lookups performed by the
      bgpcorsaro_ipmeta plugin. Other plugins should use the
      bgpcorsaro_ipmeta_get_record() function to retrieve records from this
      array */
...
struct bgpcorsaro
{
  ...
  /** A pointer to the bgpcorsaro record tag manager state */
  bgpcorsaro_tag_manager_t *tag_manager;
