...
typedef enum bgpcorsaro_plugin_id
{
   ...
   *
   * Allows Bgpcorsaro to be used to capture PCAP files from a live interface.
   * This should always be the highest priority plugin
   */
  BGPCORSARO_PLUGIN_ID_DUMP             = 1,

  /** libipmeta lookup plugin */
  BGPCORSARO_PLUGIN_ID_IPMETA           = 3,

  /** FilterGeo plugin */
  BGPCORSARO_PLUGIN_ID_FILTERGEO        = 6,

  /** FilterPfx plugin */
  BGPCORSARO_PLUGIN_ID_FILTERPFX        = 7,

  /** BGPStats plugin */
  BGPCORSARO_PLUGIN_ID_BGPSTATS         = 9,

  /** Tag stats plugin */
  BGPCORSARO_PLUGIN_ID_TAGSTATS         = 90,

  /** Maximum plugin ID assigned */
  BGPCORSARO_PLUGIN_ID_MAX              = BGPCORSARO_PLUGIN_ID_TAGSTATS
